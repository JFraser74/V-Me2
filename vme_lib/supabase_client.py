...
_SECRET_KEYS = set(
    (os.getenv("SETTINGS_SECRET_KEYS") or "OPENAI_API_KEY,SUPABASE_SERVICE_ROLE_KEY,SUPABASE_ANON_KEY,SETTINGS_ADMIN_TOKEN,GITHUB_TOKEN,GITHUB_PAT,SUPABASE_SERVICE_KEY").split(",")
)
try:
